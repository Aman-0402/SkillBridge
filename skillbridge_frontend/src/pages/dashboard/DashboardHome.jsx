      ...
      <section className="rounded-lg bg-slate-950 p-6 text-white shadow-xl shadow-slate-300/40 sm:p-8">
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-slate-300">Your ConsultME dashboard — manage projects, appointments, and expert connections all in one place.</p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button to="/consultants">
              <FaMagnifyingGlass /> Browse Consultants
            </Button>
            <Button to="/create-project" variant="secondary">
