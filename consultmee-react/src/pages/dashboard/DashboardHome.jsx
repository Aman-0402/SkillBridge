import { FaCalendarCheck, FaFolderPlus, FaMagnifyingGlass, FaStar } from 'react-icons/fa6'
...
function DashboardHome() {
  return (
    <div className="space-y-6">
      <section className="rounded-lg bg-slate-950 p-6 text-white shadow-xl shadow-slate-300/40 sm:p-8">
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.22em] text-blue-300">Welcome back</p>
            <h2 className="mt-3 text-3xl font-black sm:text-4xl">Find experts, post projects, and manage consultations.</h2>
            <p className="mt-4 max-w-2xl text-slate-300">A modern frontend dashboard shell based on the old seeker and consultant dashboards, ready for live API integration later.</p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button>
              <FaMagnifyingGlass /> Browse Consultants
            </Button>
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_0.8fr]">
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Sample cards for the converted consultant list experience.</p>
            </div>
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-slate-500">Frontend-only project cards adapted from the old Projects section.</p>
